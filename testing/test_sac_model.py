...
def main():
    parser = argparse.ArgumentParser(
        description="Run the deterministic 10-track evaluation on a trained SAC model.")
    ...
    if not args.model_path.exists():
        raise FileNotFoundError(
            ...
            f"Train one first with: python models/turtlebot_sac.py --train --seed {args.seed}"
        )
